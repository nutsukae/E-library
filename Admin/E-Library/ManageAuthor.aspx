<%@ Page Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="ManageAuthor.aspx.cs" Inherits="Admin_E_Library_ManageAuthor" Title="E-Library : Manage Author" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentTitle" Runat="Server">
    <div id="MainContentTitle">ระบบจัดการ ผู้แต่ง</div>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" Runat="Server">
     <div class="mainContentItem" align="center">
        <table width="400px" style="text-align: center">
            <tr>
                <td class="CategoryManTitle">ชื่อ ผู้แต่ง</td>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
             ...
             DataKeyNames="authorid" DataSourceID="GetAllAuthor" 
         ...
         <asp:SqlDataSource ID="GetAllAuthor" runat="server" 
             ConnectionString="<%$ ConnectionStrings:connection %>" 
             SelectCommand="sp_GetAuthorList" SelectCommandType="StoredProcedure">
         </asp:SqlDataSource>
    </div>
</asp:Content>
