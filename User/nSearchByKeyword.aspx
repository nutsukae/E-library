<%@ Page Language="C#" MasterPageFile="~/User/nUser.master" AutoEventWireup="true" CodeFile="nSearchByKeyword.aspx.cs" Inherits="User_nSearchByKeyword" Title="E-Library : Search by Keyword" %>
                     ...
                     <ItemTemplate>
                                <td id="Td2" runat="server" style="background-color:#DCDCDC;color: #000000;">
                                    <div class="productItem">
                                        <a href = '<%# "nSearchByKeyword.aspx?bookid="+Eval("bookid")+"&mode=dab" %>' target ="_blank">
