<%@ Page Language="C#" MasterPageFile="~/nUser/nUser.master" AutoEventWireup="true" CodeFile="ViewSubCat.aspx.cs" Inherits="nUser_ViewSubCat" Title="E-Library : Subcategory View" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Main_Panel" Runat="Server">
    ...
    <div>
        <asp:ListView ID="ListView1" runat="server" DataSourceID="GetBookListByCategory"  DataKeyNames="Bookid" GroupItemCount="4">
            <EmptyItemTemplate>
        ...
        <asp:SqlDataSource ID="GetBookListByCategory" runat="server" 
            ConnectionString="<%$ ConnectionStrings:connection %>" 
            SelectCommand="sp_GetBookListByCategory" SelectCommandType="StoredProcedure">
            <SelectParameters>
                <asp:QueryStringParameter DefaultValue="1" Name="SubCategoryId" 
...
<asp:Content ID="Content4" ContentPlaceHolderID="SideBar_Top_Panel" Runat="Server">
        ...
        <tr><td class="SideBar_Top_BottomText">SELECT SUBJECT</td></tr>
        <tr>
            <td class="SideBar_DropDown_Loc">
                <asp:DropDownList ID="ddlSubCategory" runat="server" 
                    CssClass="SideBar_DropDown_Item" 
...
<asp:Content ID="Content5" ContentPlaceHolderID="SideBar_Bottom_Panel" Runat="Server">
    <div>
        <asp:Panel ID="Panel1" runat="server" CssClass="SideBar_Bottom_Panel_Tmp">
        </asp:Panel>
    </div>
</asp:Content>
